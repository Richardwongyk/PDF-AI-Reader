...
def _row(source_id: str, kind: str, label: str, page: int, *, vector: bool = False) -> str:
    glyphs = [
        {"text": "h", "font": "CMMI10", "size": 10.0, "bbox": [10, 10, 16, 20]},
        {"text": "t", "font": "CMMI7", "size": 7.0, "bbox": [16, 14, 19, 21]},
        {"text": "-", "font": "CMSY7", "size": 7.0, "bbox": [19, 14, 24, 21]},
        {"text": "1", "font": "CMR7", "size": 7.0, "bbox": [24, 14, 28, 21]},
    ]
    vectors = [{"type": "line", "bbox": [8, 25, 30, 25.5]}] if vector else []
    return json.dumps(
        {
